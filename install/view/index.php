                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane" id="configuration-tab">
                            <form name="config-form" id="config-form" action="do_install.php" method="post">
                                ...
                                <div class="section clearfix">
                                    <p>3. Please enter your item purchase code. | <a href="https://discord.gg/AU4apZbpUV" target="_blank">By AlbusAbral</a></p>
                                    <hr />
                                    <div>
                                        <div class="form-group clearfix">
                                            <label for="purchase_code" class=" col-md-3">Item purchase code</label>
                                            <div class="col-md-9">
                                                <input type="text" value="AlbusAbral"  id="purchase_code"  name="purchase_code" class="form-control"  placeholder="Enter random value" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
